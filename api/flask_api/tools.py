"""flask_api OpenAI function-calling tool definitions.

Provides a ``TOOLS`` list (OpenAI format) and a ``dispatch()`` function
so that LLM agents can call flask_api as a tool.
"""
...
def dispatch(name: str, arguments: dict[str, Any] | str) -> dict[str, Any]:
    ...
    #
    #   if name == "flask_api_do_something":
